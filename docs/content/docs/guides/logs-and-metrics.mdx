...
<Cards>
  <Card title="reported.json" href="/docs/reference/reported-state" description="Every field the host writes back." />
  <Card title="Host capacity" href="/docs/guides/host-capacity" description="What the host measured this machine holds." />
</Cards>
