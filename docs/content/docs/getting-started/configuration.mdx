...
<Cards>
  <Card title="config.toml" href="/docs/reference/config" description="Every key, from the JSON Schema." />
  <Card title="Volumes" href="/docs/guides/volumes" description="Files on this disk, or blocks in an object store." />
  <Card title="HTTPS" href="/docs/guides/https" description="TLS on this host, or behind an edge." />
</Cards>
